...
EMBEDDINGS = {
    0: [-0.02646518, 0.15076376, 0.02600956, -0.11206985],
    1: [0.10870589, 0.08809305, 0.04230594, 0.03112356],
    2: [-0.0566958, 0.11723963, 0.07567911, 0.07725443],
    3: [0.00286462, 0.1879527, -0.07661887, 0.01724336]
}
...
def load_data(file_path):
    ...
    return np.hstack([norm_data, embeddings]), MinMaxScaler()
...
def build_model():
    ...
    x = Reshape((window_size, 6))(input_layer)
